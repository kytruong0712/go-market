...
type ComplexityRoot struct {
	NavigationMenu struct {
		...
		SubItems    func(childComplexity int) int
...
//go:embed "schema/_enum.graphql" "schema/_query.graphql" "schema/_type.graphql" "schema/navigation_menu.graphql"
...
var sources = []*ast.Source{
	{Name: "schema/_enum.graphql", Input: sourceData("schema/_enum.graphql"), BuiltIn: false},
	...
	{Name: "schema/navigation_menu.graphql", Input: sourceData("schema/navigation_menu.graphql"), BuiltIn: false},
}
...
func (ec *executionContext) _NavigationMenu_status(ctx context.Context, field graphql.CollectedField, obj *mod.NavigationMenu) (ret graphql.Marshaler) {
	...
	res := resTmp.(model.CategoryStatus)
	fc.Result = res
...
func (ec *executionContext) _Query_getNavigationMenu(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Query_getNavigationMenu(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
var navigationMenuImplementors = []string{"NavigationMenu"}

func (ec *executionContext) _NavigationMenu(ctx context.Context, sel ast.SelectionSet, obj *mod.NavigationMenu) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, navigationMenuImplementors)
	...
	for i, field := range fields {
		...
		case "getNavigationMenu":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query_getNavigationMenu(ctx, field)
				if res == graphql.Null {
...
func (ec *executionContext) unmarshalNCategoryStatus2githubᚗcomᚋkytruong0712ᚋgoᚑmarketᚋproductᚑserviceᚋapiᚋinternalᚋmodelᚐCategoryStatus(ctx context.Context, v interface{}) (model.CategoryStatus, error) {
	tmp, err := graphql.UnmarshalString(v)
	res := model.CategoryStatus(tmp)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNCategoryStatus2githubᚗcomᚋkytruong0712ᚋgoᚑmarketᚋproductᚑserviceᚋapiᚋinternalᚋmodelᚐCategoryStatus(ctx context.Context, sel ast.SelectionSet, v model.CategoryStatus) graphql.Marshaler {
